...
<body>
  ...
  <div class="grid-container">
    ...
    ?>
        <div class="grid-item">
          <ul class="list-group">
            <li class="list-group-item mylist"><img src="<?php echo $X['card_images'][0]['image_url'] ?>" width="250" height="365"></li>
            <li class="list-group-item mylist"><?php echo  $X['name']; ?></li>
            <li class="list-group-item mylist">
              <?php if (isset($X['level'])) {
                echo $X['level'];
                echo " ";
                echo "<img src='https://ygoprodeck.com/wp-content/uploads/2017/01/level.png' width='20' height='20'>";
              } else {
                echo 'This card has no level';
              } ?>
            </li>
            <li class="list-group-item mylist">
              <?php if (isset($X['attribute'])) {
                echo $X['attribute'];
              } else {
                echo 'This card has no attribute';
              } ?></li>
            <li class="list-group-item mylist"><?php echo  $X['race']; ?></li>
            <li class="list-group-item mylist"><?php echo  $X['type']; ?></li>
            <li class="list-group-item mylist">
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal<?php echo  $X['id']; ?>">
                More Detail...
              </button>
            </li>
          </ul>
        ...
        <div class="modal fade" id="exampleModal<?php echo  $X['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style=" color:black;">
  ...
  <div id="side">
    <div style="display:flex;justify-content:center;align-items:flex-end;">
      <div>
        <small id="tex">🌛 &copy; BlackHole🌌Studio LLC | Made with 💘 by an 👽 on a 💻 for
